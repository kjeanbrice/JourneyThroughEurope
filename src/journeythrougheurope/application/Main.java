...
public class Main extends Application implements EventHandler<WindowEvent> {
    ...
    public enum JourneyThroughEuropePropertyType {
        ...
        /* GAME TEXT */
        SPLASH_SCREEN_TITLE_TEXT, GAME_TITLE_TEXT, GAME_SUBHEADER_TEXT, WIN_DISPLAY_TEXT, LOSE_DISPLAY_TEXT, GAME_RESULTS_TEXT, GUESS_LABEL, LETTER_OPTIONS, EXIT_REQUEST_TEXT, YES_TEXT, NO_TEXT, DEFAULT_YES_TEXT, DEFAULT_NO_TEXT, DEFAULT_EXIT_TEXT,EXIT_TEXT,
        /* IMAGE FILE NAMES */
        ...
        DF_IMAGE_NAME, F4_IMAGE_NAME, F8_IMAGE_NAME, DIE1_IMAGE_NAME, DIE2_IMAGE_NAME, DIE3_IMAGE_NAME, DIE4_IMAGE_NAME, DIE5_IMAGE_NAME, DIE6_IMAGE_NAME, DEFAULT_DIE_IMAGE_NAME, ROLL_DIE_IMAGE_NAME, GAME_HISTORY_IMAGE_NAME, ABOUT_IMAGE_NAME, START_IMAGE_NAME, ABOUT_SPLASH_IMG_NAME,EXIT_ICON_IMG_NAME, NUM_CARDS_IMG_NAME,
        LOAD_IMG_NAME, BACK_IMG_NAME, GO_IMG_NAME, NUM_PLAYERS_IMG_NAME, BLUE_FLAG, LIGHTBLUE_FLAG, GRAY_FLAG, GREEN_FLAG, RED_FLAG, YELLOW_FLAG,BLUE_BUTTON,LIGHTBLUE_BUTTON, GRAY_BUTTON, GREEN_BUTTON, RED_BUTTON, YELLOW_BUTTON,MAP_IMAGE_NAME,SAVE_IMAGE_NAME,FLIGHT_PLAN_IMAGE_NAME,FLIGHT_SCREEN_IMAGE_NAME,EXIT_GAME_IMAGE_NAME,TROPHY_IMG_NAME,SAVE_IMG_NAME,
        /* DATA FILE STUFF */
