...
public class Main extends Application implements EventHandler<WindowEvent> {
    ...
    public enum JourneyThroughEuropePropertyType {
        ...
        LOAD_IMG_NAME, BACK_IMG_NAME, GO_IMG_NAME, NUM_PLAYERS_IMG_NAME, BLUE_FLAG, LIGHTBLUE_FLAG, GRAY_FLAG, GREEN_FLAG, RED_FLAG, YELLOW_FLAG,BLUE_BUTTON,LIGHTBLUE_BUTTON, GRAY_BUTTON, GREEN_BUTTON, RED_BUTTON, YELLOW_BUTTON,MAP_IMAGE_NAME,SAVE_IMAGE_NAME,
        /* DATA FILE STUFF */
