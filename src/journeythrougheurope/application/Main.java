...
public class Main extends Application implements EventHandler<WindowEvent> {
    ...
    public enum JourneyThroughEuropePropertyType {
        ...
        DF_IMAGE_NAME, F4_IMAGE_NAME, F8_IMAGE_NAME, DIE1_IMAGE_NAME, DIE2_IMAGE_NAME, DIE3_IMAGE_NAME, DIE4_IMAGE_NAME, DIE5_IMAGE_NAME, DIE6_IMAGE_NAME, DEFAULT_DIE_IMAGE_NAME, ROLL_DIE_IMAGE_NAME, GAME_HISTORY_IMAGE_NAME, ABOUT_IMAGE_NAME, START_IMAGE_NAME, ABOUT_SPLASH_IMG_NAME,EXIT_ICON_IMG_NAME,
